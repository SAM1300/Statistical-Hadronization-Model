...
void prediction(){
  ...
  // Double_t Tch = 0.160,  muB = 0.1, muS = 0.025, muQ = 0.0;// GeV
  Double_t Tch = 0.150,  muB = 0.1, muS = 0.025, muQ = 0.0;// GeV
  ...
  Int_t idRatio[7]={313,333,3122,-3122,3312,-3312,3334};
  for(Int_t iRatio = 0;iRatio<7;iRatio++)
  {
    lRatio = fit.GetYield(idRatio[iRatio],321,"PREDICTION");
    printf(" %d \t %d \t %s \t %6f \n",lRatio->GetID1(),lRatio->GetID2(),lRatio->GetTMName().Data(),lRatio->GetModelValue());
  }
